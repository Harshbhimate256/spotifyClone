...
function SearchFeed({setInput,Call,data}) {
  ...
  return (
    <div className="SFcontainer bg-[#101010] rounded-xl overflow-hidden">
      <div className="searchForm flex w-full p-4 gap-3 bg-transparent fixed rounded-xl items-center ">
        ...
        />
        <button onClick={()=> Call() && setinput(true)} className="bg-[#242424] w-[5vw] border-[1px] ml-2 h-12 p-5 flex justify-center items-center rounded-full text-[#ffffff] hover:bg-[#2e2e2e]">
          search
        </button>
      </div>
